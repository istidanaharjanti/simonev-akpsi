...
class PJFungsionalList extends Component {
  constructor(props) {
    ...
    let url = `${process.env.API_HOST}/pejabatf/evaluasi/spse/2018`;
    const column = [
      ...
      { "sTitle": "Petugas PPK", "mDataProp": "ppk_nama", "sWidth": "20px" },
      {
  ...
  getSPSEdata(params) {
    const self = this;
    const url = `${process.env.API_HOST}/pejabatf/evaluasi/spse/2018`;
